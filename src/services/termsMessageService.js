...
function buildTermsEmbed() {
  ...
  // Keep the footer explicitly in the final Discord payload so it cannot be
  // dropped by later embed transformations.
...
async function findExistingTermsMessage(channel, clientUserId) {
  ...
  return messages.find(message =>
    ...
    message.embeds?.some(embed => embed.title === 'Terms of Service')
  ) || null;
}
